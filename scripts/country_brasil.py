...
housing_burden = (br["gasto_vivienda_usd"] / br["ingreso_mensual_usd"] * 100).mean()
...
for col in gasto_cols:
    spending[col] = (br[col] / br["ingreso_mensual_usd"] * 100).mean()

mean_savings = br["ahorro_mensual_usd"].mean()
pct_neg = (br["ahorro_negativo"] == "ahorro negativo").mean() * 100

mean_ia = br["horas_herramientas_ia_semana"].mean()
mean_sat = br["satisfaccion_financiera"].mean()
